...
def test_rank3_gain_35_volume_1_2_is_traded() -> None:
    signal = Top3Signal(symbol="AAAUSDT", rank=3, gain_24h=0.35, volume_24h_ratio_7d=1.2)

    assert is_trade_signal(signal) is True


def test_rank2_gain_35_volume_below_1_5_is_still_filtered() -> None:
...
def test_40_60_bucket_requires_rank2_and_volume_3_to_5_5() -> None:
    ...
    volume_5_49 = Top3Signal(symbol="EEEUSDT", rank=2, gain_24h=0.45, volume_24h_ratio_7d=5.49)
    volume_5_5 = Top3Signal(symbol="DDDUSDT", rank=2, gain_24h=0.45, volume_24h_ratio_7d=5.5)
    ...
    assert is_trade_signal(volume_5_49) is True
    assert is_trade_signal(volume_5_5) is False
...
def test_gain_above_80_percent_is_filtered() -> None:
    signal = Top3Signal(symbol="AAAUSDT", rank=2, gain_24h=0.80, volume_24h_ratio_7d=2.5)

    assert is_trade_signal(signal) is False


def test_gain_above_90_percent_is_filtered() -> None:
    signal = Top3Signal(symbol="AAAUSDT", rank=2, gain_24h=0.95, volume_24h_ratio_7d=2.5)
